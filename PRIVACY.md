# Politique de confidentialité — Redirection de domaines
...
| --- | --- | --- |
| Redirections | `odoo.client.fr` → `client-prod-1234.odoo.com` | `chrome.storage.sync` |
| Environnements | `https://client-prod-1234.odoo.com` | `chrome.storage.sync` |
| Recherches | `Ticket` → `/odoo/helpdesk/{q}` | `chrome.storage.sync` |
